...
import com.wes.project_1918083_tokopakaian.databinding.ActivityAddContactBinding;
...
public class AddContact extends AppCompatActivity {
    ...
    private void editData() {
        if (getIntent().getBundleExtra("userdata")!= null){
            ...
            binding.edtnomer.setText(bundle.getString("nomer"));
            //for image
    ...
    private void insertData() {
        binding.btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                cv.put("nomer",binding.edtnomer.getText().toString());
                cv.put("avatar", imageViewToBy(binding.edtimage));
                sqLiteDatabase = dBmain.getWritableDatabase();
                Long rec = sqLiteDatabase.insert("contactsupplier",null ,cv);
                if (rec != null) {
                    Intent a = new Intent(AddContact.this, MainActivity4.class);
                    startActivity(a);
                    Toast.makeText(AddContact.this, "Data Inserted", Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(AddContact.this, "Something Wrong", Toast.LENGTH_SHORT).show();
                }
            }
        });
        //for view display
        binding.btnDisplay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent( AddContact.this, MainActivity4.class));
            }
        });
        ...
        binding.btnEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(recedit != -1){
                    Toast.makeText(AddContact.this, "Update Succesfully", Toast.LENGTH_SHORT).show();
                    //clear data adfte submit
                    binding.edtname.setText("");
                    binding.edtnomer.setText("");
